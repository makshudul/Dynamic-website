...
include '../db.php';
$id=$_GET['id'];
$single_user="SELECT * FROM comments WHERE id='$id'";
                            ...
                            <div class="card-body">
                              <form action="edit_comment.php" method="POST">
                               ...
                               <input type="hidden" placeholder="Enter Name" name="id" class="form-control " value="<?=$after_assoc['id']?>">
                                <label > Name</label>
                                <input type="text" placeholder="Enter Logo" name="name" class="form-control" value="<?=$after_assoc['name']?>">
                               </div>
                               <div class="form-group">
                                <label >Position</label>
                                <input type="text" placeholder="Enter Title" name="position" class="form-control" value="<?=$after_assoc['position']?>">
                               </div>
                               <div class="form-group">
