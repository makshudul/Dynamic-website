                ...
                <div class="col-lg-12">
                    <div class="card ">
                        <div class="card-header">
                            <div class="float-left "> <h3>Comments view</h3> </div>
                        </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <?php foreach ($select_comments_result as $index=>$User) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($User['status']==0) {?>
                                            <a href="comment_status.php?id=<?= $User['id']?>" class=" btn btn-secondary">Deactive</a>
                                            <?php } else {?>
                                                <a href="comment_status.php?id=<?= $User['id']?>" class=" btn btn-success">Active</a>
                                            <?php }?>
                                            <a href="edit_comment_page.php?id=<?= $User['id']?>" class=" btn btn-primary">edit</a>
                                            <?php if($User['status']==0) {?>
                                            <button name="comment_delete.php?id=<?= $User['id']?>" type="button" class=" comment_delete btn btn-danger"> Delete</button>
                                        <?php }?>
                                  ...
                                  <?php if (mysqli_num_rows($select_comments_result)==0) {?>
                                     <tr>
