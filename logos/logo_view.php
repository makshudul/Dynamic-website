                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <?php foreach ($select_logo_result as $index=>$User) { ?>
                              
                                <tr>
                                    <td> <?= $index+1?></td>
                                   <td>
                                     <img width="200" src="/panda/uploads/logos/<?= $User['logo']?>" alt="">
                                    </td>
                             
                                    <td>
                                        <?php if($User['status']==0) {?>
                                            <a href="logo_status.php?id=<?= $User['id']?>" class=" btn btn-secondary">Deactive</a>
                                            <?php } else {?>
                                                <a href="logo_status.php?id=<?= $User['id']?>" class=" btn btn-success">Active</a>
                                            <?php }?>
                                            <a href="logo_edit_page.php?id=<?= $User['id']?>" class=" btn btn-primary">Edit</a>
                                            <?php if($User['status']==0) {?>
                                        <button name="logo_delete.php?id=<?= $User['id']?>" type="button" class=" delete btn btn-danger"> Delete</button>
                                        <?php }?>
                                    </td>
                                </tr>
                                  ...
                                  <?php if (mysqli_num_rows($select_logo_result)==0) {?>
                                     <tr>
