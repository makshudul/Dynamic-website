                           ...
                           <div>
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                <label class="form-lable" >Logo Name </label>
                                <input type="text" placeholder="Enter Logo Name" name="logo" class="form-control">
                             </div> 
                               <div class="form-group">
                                <label class="form-lable" >Title </label>
                                <input type="text" placeholder="Enter Skill Name" name="title" class="form-control">
                             </div> 
                             <div class="form-group">
