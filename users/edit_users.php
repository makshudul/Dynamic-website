                            ...
                            <div class="card-body">
                              <form action="users_update.php" method="POST" enctype="multipart/form-data">
                               ...
                               <input type="hidden" placeholder="Enter Name" name="id" class="form-control " value="<?=$after_assoc['id']?>">
                                <label >Name</label>
                                <input type="text" placeholder="Enter Name" name="name" class="form-control" value="<?=$after_assoc['name']?>">
                               </div>
                               <div class="form-group">
                                <label for="exampleInputPassword1">Email</label>
                                <input type="email"  placeholder="Ener email"name="email" class="form-control" value="<?=$after_assoc['email']?>">
                               </div>
                               <div class="form-group">
                                <label for="exampleInputPassword1">Present image </label>
                                <img width="200" src="/panda/uploads/users/<?= $after_assoc['profile_img']?>" alt="">
                               </div>
                               <div class="form-group">
