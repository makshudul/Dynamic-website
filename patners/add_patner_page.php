                  ...
                  <div class="col-lg-8 m-auto">
                     <div class="card">
                         <div class="card-header ">
                           <div>
                             <h3 class="float-left">Add Patner</h3>
                           </div>
                            </div>
                            <div class="card-footer ">
                           <div>
                           <form action="add_patner.php" method="POST" enctype="multipart/form-data">
                             <div class="form-group">
                                <label >Image</label>
                                <input type="file" name="image" class="form-control">
                             </div>
                             <div class="text-center">  
                               <button type="submit" class="btn btn-primary"> Add Patner</button>
                            </div>
